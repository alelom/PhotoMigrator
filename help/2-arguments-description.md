...
There is also a [shorter version](https://github.com/alelom/PhotoMigrator/blob/main/help/2-arguments-description-short.md) of this document available.
...
| `-fnNoAlbums`,<br>`--foldername-no-albums`         | `<NO_ALBUMS_FOLDER>`         |  string  |           `any folder name` (default: `ALL_PHOTOS`)            | Specify the folder name to store all your processed photos (including those associated to Albums). |
