...
PhotoMigrator v3.7.0 - 2026-01-09
...
-dashboard   ; --dashboard = [true,false]
               ...
               both '--source' and '--target' arguments are given (Automatic Migration).
               (default: True).
...
-gnsa        ; --google-no-symbolic-albums
               ...
               IMPORTANT: This increments considerably the Output Takeout Folder size, specially if you have many
               Albums.
...
-gSkipGpth   ; --google-skip-gpth-tool
               ...
               CAUTION: This option is NOT RECOMMENDED because this is the Core of the Google Photos Takeout Process.
               Use this flag only for testing purposes.
-gSkipPrep   ; --google-skip-preprocess
               Skip Pre-process Google Takeout which has following steps:
...
-procDup     ; --process-duplicates <DUPLICATES_REVISED_CSV>
               Specify the Duplicates CSV file revised with specifics Actions in Action column, and the Tool will
               execute that Action for each duplicates found in CSV. Valid Actions: restore_duplicate / remove_duplicate
               / replace_duplicate.
---------------------------------------------------------------------------------------------------------
```
