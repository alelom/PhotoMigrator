...
>     - [Install Docker on Windows](https://github.com/alelom/PhotoMigrator/blob/main/help/install-docker/install-docker-windows.md)  
>     - [Install Docker on Linux](https://github.com/alelom/PhotoMigrator/blob/main/help/install-docker/install-docker-linux.md)  
>     - [Install Docker on MacOS](https://github.com/alelom/PhotoMigrator/blob/main/help/install-docker/install-docker-macos.md)  
...
Download the latest version of the Docker package from the [Releases page](https://github.com/alelom/PhotoMigrator/releases), or use the following command:

- **Linux/macOS:**
    ```bash
    curl -L -o PhotoMigrator_v3.7.0_docker.zip https://github.com/alelom/PhotoMigrator/releases/download/v3.7.0/PhotoMigrator_v3.7.0_docker.zip
    ```
  
- **Windows (PowerShell):**
    ```bash
    curl.exe -L -o PhotoMigrator_v3.7.0_docker.zip https://github.com/alelom/PhotoMigrator/releases/download/v3.7.0/PhotoMigrator_v3.7.0_docker.zip
    ```
...
- **Linux/macOS:**
    ...
    7z x PhotoMigrator_v3.7.0_docker.zip
    cd PhotoMigrator/docker
    ```

- **Windows (PowerShell):**
    ```bash
    powershell -Command "Expand-Archive -Path PhotoMigrator_v3.7.0_docker.zip -DestinationPath ./"
    cd PhotoMigrator\docker
    ```
...
> For more information, refer to [Configuration File](https://github.com/alelom/PhotoMigrator/blob/main/help/0-configuration-file.md).
